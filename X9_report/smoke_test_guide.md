...
> _**NOTE: This smoke test guide is written with the help of Generative AI given the context of all internal smoke tests documents written by Sean and I throughout the development of X9.**_
> 
> Follow the guide to test fully the intended functionality of X9.
> 
...
**Setup:** Fresh installation on API 33+ device. Revoke all permissions if re-testing.
